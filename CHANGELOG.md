...
### Fixed
- **Dashboard Script Injection**: Fixed critical bug where `serveHtml` broke all `<script src="...">` tags when injecting `window.APP_VERSION`. ([#5](https://github.com/youssefvdel/qwenhub/issues/5))
...
- **One-Command Install Script**: `curl -sSL https://raw.githubusercontent.com/youssefvdel/qwenhub/main/install.sh | bash`
...
[0.7.0]: https://github.com/youssefvdel/qwenhub/compare/v0.6.0...v0.7.0
[0.6.0]: https://github.com/youssefvdel/qwenhub/compare/v0.5.1...v0.6.0
[0.5.0]: https://github.com/youssefvdel/qwenhub/compare/v0.4.0...v0.5.0
[0.4.0]: https://github.com/youssefvdel/qwenhub/compare/v0.3.1...v0.4.0
[0.3.1]: https://github.com/youssefvdel/qwenhub/compare/v0.3.0...v0.3.1
[0.3.0]: https://github.com/youssefvdel/qwenhub/compare/v0.2.0...v0.3.0
[0.2.0]: https://github.com/youssefvdel/qwenhub/compare/v0.1.0...v0.2.0
[0.1.0]: https://github.com/youssefvdel/qwenhub/compare/v0.0.1...v0.1.0
[0.0.1]: https://github.com/youssefvdel/qwenhub/releases/tag/v0.0.1
