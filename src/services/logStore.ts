 ...
 * for viewing at http://qwenhub/log (SSE) and http://qwenhub/log/json
 *
...
export interface LogEntry {
  ...
  promptToQwen?: {
    ...
    clientTokens?: number;
    /** Estimated tokens from content injected by qwenhub (system prompt, formatting, tool instructions) */
