...
import { startRefreshScheduler } from './services/refreshScheduler.ts';
...
▀▀███ ████▄  ▀███████████     ███     ▀▀███▀▀▀
  ...
  async function startServer() {
    ...
    (async () => {
      ...
      // ★ Proactive token refresh — keep the pool warm so requests never pay refresh latency
